...
const Recap2023: React.FC = () => {
  const scrollTo = (id: string) => {
    const el = document.getElementById(id);
    if (el) window.scroll({behavior: 'smooth', top: el.offsetTop});
  };
  ...
  return (
    <div className={'overflow-x-hidden'}>
      ...
      <div className={'bg-blue-12 text-blue-1 relative flex items-end ' +
        'min-h-[60vh] pt-36 tabletL:pt-44 xl:pt-48 pb-12 px-8 md:px-16 overflow-hidden'}>
        ...
        <div className={'relative z-10 max-w-[900px]'}>
          ...
          <p className={'text-blue-5 text-text-l md:text-head-s ' +
            ...
            02.01. – 08.01.2023 · Remote · Non-Profit ·
            150 Studierende · 25+ Teams
          </p>
        </div>
      ...
      <div id={'rueckblick'}
        ...
        <Caret
          className={'caret-left hidden 850-h:block'}
          onClick={() => scrollTo('bericht')} />
      </div>

      {/* ── BERICHT ── */}
      <div id={'bericht'} className={'bg-blue-1'}>
        ...
        <div className={'max-w-[800px] mx-auto px-6 pb-20 ' +
          'text-text-m md:text-text-l text-blue-12 leading-relaxed ' +
          'flex flex-col gap-5'}>

          <img
            src={groupPicture}
            alt="Gruppenbild LLT Hackathon 2023"
            className={'w-full rounded mb-2'}
          />

          <h2 className={'text-head-m md:text-head-l font-semi-bold'}>
            „ComplAI" gewinnt bundesweit größten Hackathon im Bereich Legal Tech
          </h2>
          ...
          <p className={'text-justify'}>
            ...
            Thema Legal Tech erhalten konnte.
          </p>

          <p className={'text-justify'}>
            Rund <strong>150 Studierende aus ganz Deutschland</strong> und den
            verschiedensten Disziplinen kamen remote zusammen, um von Legal Tech
            Expert:innen zu lernen, sich auszutauschen und in über 25 Teams mit
            ihren entwickelten Lösungen die Jury zu überzeugen. Dabei konnten
            die Teams aus von den Veranstalter:innen gestellten Problemen
            auswählen, auf die durch das Kursprogramm dezidiert vorbereitet
            wurde, oder eigene Herausforderungen mitbringen, denen sie mit ihrem
            Legal Tech Tool begegnen wollten.
          </p>

          <p className={'text-justify'}>
            Zum offiziellen Start des Hackathons am 2. Januar richtete
            der <strong>Bayerische Staatsminister der Justiz Georg
            Eisenreich</strong> als <strong>Schirmherr des LLT</strong> motivierende
            Worte an die Teilnehmenden und betonte die Chancen von Legal Tech
            in der Breite sowie die Wichtigkeit von Formaten wie dem LLT Hackathon.
          </p>
          ...
          <p className={'text-justify'}>
            ...
            Start-Ups einging. Dabei verriet er unter anderem, welche Bedeutung
            frühzeitiges Marketing hat und wie man am besten mit unerwarteten
          ...
          <p className={'text-justify'}>
            Mit dem fünften Tag des LLT Hackathons folgte der letzte inhaltlich
            intensive Tag für die Teams. Neben dem letzten Teil des Coding
            Kurses folgten mit den Vorträgen von Matthias Grabmair
            („Data driven work for lawyers") und Ann-Kristin Mayrhofer zu
            elektronischen Postfächern nochmals echte Highlights. Darüber hinaus
            lud das Liquid Legal Institute am Abend zu einem zwanglosen Austausch
            am digitalen open table ein.
          </p>
          ...
          <p className={'text-justify'}>
            Der <strong>erste Platz</strong> ging an das{' '}
            <strong>Team „ComplAI"</strong>, die mit ihrer Lösung auf die
            Probleme kleinerer Unternehmen eingingen. Damit diese stets den
            Überblick über Gesetzesänderungen, anstehende Neuregulierungen und
            für sie wichtige Gerichtsentscheidungen behalten können, entwickelte
            ComplAI ein <strong>Benachrichtigungstool</strong>. Matthias Grabmair
            betonte bei seiner Gratulation die Relevanz und Cleverness der Idee.
            Besonders hervorzuheben sei außerdem, dass das Konzept bereits
            relativ weit ausgereift sei und ein existierendes Problem vieler
            (Klein-)Unternehmer adressiere.
          </p>

          <p className={'text-justify'}>
            <strong>Platz zwei</strong> konnte sich das{' '}
            <strong>Team „LiKA"</strong> sichern, die einen{' '}
            <strong>Lieferkettenassistenten</strong> zur Bewältigung der durch
            das Lieferkettensorgfaltspflichtengesetz (LkSG) aufgestellten
            Anforderungen entwickelten. Kirsten Rulf ging in ihrer Laudatio auf
            die unmittelbaren und mittelbaren Folgen des LkSG ein und zeigte
            die Bedeutung dessen auf. LiKA leiste hierbei einen wichtigen
            Beitrag zur Umsetzung und stelle einen zusätzlichen Anreiz für
            Unternehmen dar, sich mit dem Thema zu beschäftigen.
          </p>
          ...
          <p className={'text-justify'}>
            ...
            der Vielfalt der gepitchten Ideen und sah beachtliche Entwicklungen
            zu ihrer früheren Studienerfahrungen. Besonders überzeugen konnte
            die Jury auch der <strong>Prozesskostenkompass</strong>. Dieser
            bietet einer großen Anzahl von Personen unmittelbare und leicht
            verständliche Unterstützung bei der Beantragung von
            Prozesskostenhilfe und fördert so den Zugang zum Recht. Er hilft
            unkompliziert dort, wo Hilfe dringend gebraucht wird. Der bereits
            sehr weit entwickelte Prototyp sicherte dem Team so den dritten Platz.
          </p>
          ...
          <p className={'text-justify'}>
            ...
            das Siegerteam zu einem{' '}
            <strong>Gespräch im Bayerischen Staatsministerium der Justiz</strong>{' '}
            ein. Daneben kann sich das Team von ComplAI über den begehrten{' '}
            <strong>LLT Pokal, 2.500 Euro Preisgeld und ein Interview in der
            Zeitschrift Recht Digital (RDi)</strong> freuen.
          </p>

          <p className={'text-justify'}>
            Der LLT Hackathon lebte über die gesamte Woche von einer engagierten
            Community, die sich Tag und Nacht über die eingerichteten Slack
            Channels austauschte und Problemen stets mit einer gewissen Prise
            Humor begegnete. So wundert es nicht, dass Teilnehmende auch rege
            den eingerichteten Meme-Channel befüllten. Bis zuletzt wurde hier
            gepostet, um sich noch eine Chance in der parallelen{' '}
            <strong>Meme Challenge</strong> zu sichern.
          </p>

          <p className={'text-justify'}>
            Das <strong>Organisationsteam</strong> (Sebastian Nagl, Sarah Rachut,
            Muskaan Multani, Fabian Wiedemann, Ann-Sophie Blaser und Charlie
            Tiehm) konnte diese erfolgreiche Woche somit mit Glückwünschen an
            die Gewinnerteams und einem großen Dank an alle Teilnehmenden, für
            das außerordentliche Engagement der Vortragenden und Jurymitglieder
            sowie für den Einsatz des Schirmherrn schließen.
          </p>
