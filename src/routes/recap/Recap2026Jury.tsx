...
// Jury roster mirrored from the current /jury page.
...
// Recap2026Jury – "Die Jury" subpage of the 2026 recap. Mirrors the roster
// shown on the current /jury page.
export function Recap2026Jury() {
  return (
    <RecapSubpageLayout title={'Die Jury'} backTo={'/recap/2026'}>
              ...
              {member.img ?
                <img
                  ...
                  className={'w-40 h-40 lg:w-48 lg:h-48 rounded-full ' +
                    'object-cover ' +
                    (member.imgPosition || 'object-center')}/> :
