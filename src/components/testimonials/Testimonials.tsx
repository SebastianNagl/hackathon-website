  ...
  cards: Testimonial[] = [
    {
      name: 'Kirsten Rulf',
      text:
        'Im Bereich LegalTech liegt für die Justiz die Chance,' +
    ...
    },
    {
      img: bernhardWaltl,
      text:
        'Der Rechtsmarkt der Zukunft braucht Kollaboration und Hands-on' +
    ...
    {
      text:
        'Der Hackathon bietet allen Beteiligten eine optimale' +
    ...
    },
    {
      img: dirkHartung,
      text:
        'Ein großer Wettbewerb bei dem es auf gute Ideen und deren' +
    ...
    {
      text:
        'Bei einem Hackathon steht von vornherein fest: Ausnahmslos alle ' +
    ...
    {
      text:
        'Der LegalLovesTech Hackathon bietet die ideale Plattform für' +
    ...
    {
      text:
        'Täglich erzeugt die Justiz tausende von Datensätzen, die ' +
    ...
    {
      text:
        'Der Legal Loves Tech Hackathon ist eine großartige' +
    ...
    {
      text:
        'Dieser Hackathon lohnt sich auch für alle Personen, die in ' +
    ...
    {
      text:
        'Der LLT Hackathon ist eine großartige Gelegenheit, an der' +
    ...
    {
      text:
        'Technologische Innovation als Schlüsselressource für unsere' +
  ...
  render() {
    return (
      ...
      >
        <div
          className={
            'absolute top-8 left-0 rounded-r z-10 bg-blue-12 ' +
          ...
          <div className={'block w-full h-full py-4 relative'}>
            ...
            >
              {this.cards.map((testimonial, i) => (
                <SwiperSlide key={i} className='block rounded'>
